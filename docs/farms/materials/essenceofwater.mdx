...
### Macro
The following macro works for druids, but simply replace the `/use moonfire` with whatever spell your class uses for instant damage. This macro targets the <WowHeadNpc id="691">Lesser Water Elemental</WowHeadNpc> and casts Moonfire.  
