...
export default function WowHeadItem({children, id, showGold=true}) {
...
{showGold == true ? <a href={goldUrl} target="_blank"><img src="/img/coin-32.png" alt="Gold" style={{width: 11, height: 11, marginLeft:7}}></img></a> : null}
</span>
  );
}
